...
public class AudioplayersPlugin implements MethodCallHandler {
    ...
    public static void registerWith(final Registrar registrar) {
        ...
        final AudioplayersPlugin handler = new AudioplayersPlugin(channel);
    ...
    private void onDestroy() {
        System.out.println("plugin audio player onDestroy");
        for (Map.Entry<String, WrappedMediaPlayer> entry : mediaPlayers.entrySet()) {
